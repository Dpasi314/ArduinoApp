...
public class DeviceCommunicatorService extends Service {
    ...
    final static String DATA_RECEIVED_INTENT = "com.atomic.ArduinoApp.intent.action.DATA_RECEIVED";
    final static String SEND_DATA_INTENT = "com.atomic.ArduinoApp.intent.action.SEND_DATA";
    final static String DATA_SENT_INTERNAL_INTENT = "com.atomic.ArduinoApp.internal.intent.action.DATA_SENT";
    final static String DATA_EXTRA = "com.atomic.ArduinoApp.intent.extra.DATA";
