package com.atomic.ArduinoApp.DataHandler;
...
public class CommunicatorService extends Service {
    ...
    private class SenderThread extends Thread {
        ...
        public SenderThread(String process) {
            super(process);
        }
        ...
        public void run() {
            ...
            mHandler = new Handler() {
                ...
                public void handleMessage(Message message) {
                    if (message.what == 10) {
                        final byte[] sendData = (byte[]) message.obj;
                        final int len = mUsbConnection.bulkTransfer(mOutUsbEndpoint, sendData, sendData.length, 0);
                        Intent sendIntent = new Intent(DATA_SENT_INTERNAL_INTENT);
                        sendIntent.putExtra(DATA_EXTRA, sendData);
